...
namespace nav2_mod_planner {
    ...
    private:
        ...
        class FootprintStateValidityChecker : public ompl::base::StateValidityChecker {
        public:
            FootprintStateValidityChecker(const ompl::base::SpaceInformationPtr &si,
                                          nav2_costmap_2d::FootprintCollisionChecker<nav2_costmap_2d::Costmap2D *> *checker,
                                          const std::vector<geometry_msgs::msg::Point> &footprint)
                    : ompl::base::StateValidityChecker(si), checker_(checker), footprint_(footprint) {}
            ...
            bool isValid(const ompl::base::State *state) const override {
                return checker_->footprintCostAtPose(
                        ...
                        footprint_) >= nav2_costmap_2d::LETHAL_OBSTACLE;
            }
